...
function printGangInformation(ns) {
    ...
    const nextRecruit = gangInformation.respectForNextRecruit === Infinity ?
        "N/A" : doConversion(gangInformation.respectForNextRecruit);
    ...
    printInfo(ns, `${gangInformation.faction}  (${gangInformation.isHacking ? "Hacking" : "Combat"} Gang)`);
