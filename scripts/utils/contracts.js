...
export function getContractScript(ns, contractType) {
  switch (contractType) {
    ...
    case ns.enums.CodingContractName.AlgorithmicStockTraderI:
      return {
        scriptName: "algorithmic_stock_trader_1.js",
        scriptCallback: algorithmicStockTrader1,
      };
    case ns.enums.CodingContractName.AlgorithmicStockTraderII:
      return {
        scriptName: "algorithmic_stock_trader_2.js",
        scriptCallback: algorithmicStockTrader2,
      };
    case ns.enums.CodingContractName.AlgorithmicStockTraderIII:
      return {
        scriptName: "algorithmic_stock_trader_3.js",
        scriptCallback: algorithmicStockTrader3,
      };
    case ns.enums.CodingContractName.AlgorithmicStockTraderIV:
      return {
        scriptName: "algorithmic_stock_trader_4.js",
        scriptCallback: algorithmicStockTrader4,
      };

    case ns.enums.CodingContractName.ArrayJumpingGame:
      return {
        scriptName: "array_jumping_game.js",
        scriptCallback: arrayJumpingGame,
      };

    case ns.enums.CodingContractName.EncryptionICaesarCipher:
      return {
        scriptName: "encryption_I_caesarCipher.js",
        scriptCallback: caesarCipher,
      };

    case ns.enums.CodingContractName.HammingCodesEncodedBinaryToInteger:
      return {
        scriptName: "hamming_codes_binary_to_integer.js",
        scriptCallback: hammingCodeBinaryToInteger,
      };

    case ns.enums.CodingContractName.FindLargestPrimeFactor:
      return {
        scriptName: "largest_prime_factor.js",
        scriptCallback: findLargestPrimeFactor,
      };
    case ns.enums.CodingContractName.MergeOverlappingIntervals:
      return {
        scriptName: "merge_overlapping_intervals.js",
        scriptCallback: mergeOverlappingIntervals,
      };
    case ns.enums.CodingContractName.MinimumPathSumInATriangle:
      return {
        scriptName: "minimum_path_sum_triangle.js",
        scriptCallback: triangleMinimumPathSum,
      };
    ...
    case ns.enums.CodingContractName.UniquePathsInAGridI:
      return {
        scriptName: "unique_paths_grid_1.js",
        scriptCallback: uniquePathsInGrid1,
      };
    case ns.enums.CodingContractName.UniquePathsInAGridII:
      return {
        scriptName: "unique_paths_grid_2.js",
        scriptCallback: uniquePathsInGrid2,
      };
